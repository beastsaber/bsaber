<script lang="ts">
  ...
  let errorCode: string = `${page.status}`
  let errorMessage: string = page.error?.message || 'Unknown Error'
...
<MetaHead title={errorMessage} description={errorDescription} />
