<article>
  <div class="title-header-container">
    <h1 class="main-header">Getting Started with Beat Saber</h1>
    <div class="darkening-container" />
  </div>
  ...
  <div class="article-body">
    ...
    <p>Sometimes, the fun is in competing. If that's you then you will want the respective mods for <a href="https://beatleader.xyz/">BeatLeader</a> and <a href="https://scoresaber.com/">ScoreSaber</a>. Both of these provide leaderboards for you to compare with friends or the worlds on custom songs. Using the mods you'll be able to submit your own scores (with the replays), see the leaderboard in game and even collect performance points (short pp) which are used to rank you in the world.</p>
    
    <h2>Communities</h2>
    <p>If you're here to mingle then you'll find many communities that might just be for you. We will be hosting an list of communities soon - so stay tuned!</p>
...
<style lang="scss">
  ...
  .title-header-container {
    ...
    background-image: url('/Beat-Saber-1024x576.jpg');
    z-index: 0;
  }
