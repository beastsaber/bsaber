...
<MetaHead
  title="Diamonds in the Rough - Vol. 6"
  ...
  imageUrl="/uploads/posts/ditr/ditr6-square.jpg"
/>
...
<section class="hero">
  <div class="content">
    ...
    <div class="body">
      <h1>Diamonds in the Rough - Vol. 6</h1>
      <p>
    ...
    <div class="zip-one">
      <a
        class="zip"
        href="https://api.beatsaver.com/playlists/id/641464/download"
    ...
    <div class="buttons">
      <a class="btn" href="https://beatsaver.com/playlists/641464">BEATSAVER</a>
    </div>
  </div>
</section>
<br />
...
<style>
  ...
  .hero::before {
    ...
    width: 100%;
    height: 100%;
    background: url('/uploads/posts/ditr/ditr6-square.jpg') no-repeat center center;
    background-size: cover;
