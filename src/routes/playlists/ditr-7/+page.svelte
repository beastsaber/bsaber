...
<section class="hero">
  <div class="content">
    ...
    <div class="body">
      <h1>Diamonds in the Rough - Vol. 7</h1>
      <p>
    ...
    <div class="zip-one">
      <a
        class="zip"
        href="https://api.beatsaver.com/playlists/id/978394/download"
        title="Zip Download via BeatSaver"><Fa icon={faDownload} /></a
      >
      <a
        class="one"
        href="bsplaylist://playlist/https://api.beatsaver.com/playlists/id/978394/download"
        title="OneClick&trade; Install via BeatSaver"><Fa icon={faCloudDownloadAlt} /></a
      >
    </div>
    <div class="buttons">
      <a class="btn" href="https://beatsaver.com/playlists/978394">BEATSAVER</a>
    </div>
  </div>
</section>
<br />
...
<hr class="fade" />
<MapCards playlistId={978394} showToggle={false} />
...
<style>
  ...
  .hero::before {
    ...
    width: 100%;
    height: 100%;
    background: url('/uploads/posts/ditr/ditr7-square.png') no-repeat center center;
    background-size: cover;
